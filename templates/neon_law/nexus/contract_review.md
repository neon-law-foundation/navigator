...
# Entity's playbook, an attorney reviews every finding at `lawyer_review`, and the firm delivers
# a review memo (rendered web-side from the approved findings into `generate_pdf__review_memo`).
