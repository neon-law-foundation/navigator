...
custom_questions:
  ...
  annual_salary:
    prompt: What is the annual base salary?
  pay_schedule:
    prompt: How often is the employee paid?
questionnaire:
  BEGIN:
    _: entity__nonprofit
  entity__nonprofit:
...
The Employee signs this Agreement electronically; the Organization's authorized officer signs above.
