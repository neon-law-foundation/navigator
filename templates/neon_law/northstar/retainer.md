...
`{{custom_text__client_name}}` (the "Client"), reachable at `{{custom_text__client_email}}`, for **Neon Law Northstar**
— estate planning — on the matter referred to as `{{custom_text__project_name}}`.
