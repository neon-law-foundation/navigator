...
(the "Firm"), and `{{custom_text__client_name}}` (the "Client"), reachable at `{{custom_text__client_email}}`, for the
litigation matter referred to as `{{custom_text__project_name}}`.
