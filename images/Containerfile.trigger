...
# nor a release archive. AGPL § 4 conditions the permission to convey on handing
# every recipient this License along with the work, so the text rides in the
# runtime layer beside the binary — and under § 13 that holder may owe the source
# onward in turn, which they cannot do from terms they were never shown. The
# label is the registry-native form of the same statement: Artifact Registry and
# GHCR read it for the package page, where a puller actually looks.
