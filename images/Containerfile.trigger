...
# nor a release archive. MIT conditions its permission on the notice travelling
# with every copy and Apache-2.0 § 4(a) obliges a redistributor to hand over the
# License, so both texts ride in the runtime layer beside the binary. The label
# is the registry-native form of the same statement: Artifact Registry and GHCR
# read it for the package page, where a puller actually looks.
LABEL org.opencontainers.image.licenses="MIT OR Apache-2.0" \
      org.opencontainers.image.vendor="Neon Law Foundation"

COPY LICENSE.md     /app/LICENSE.md
COPY LICENSE-MIT    /app/LICENSE-MIT
COPY LICENSE-APACHE /app/LICENSE-APACHE
