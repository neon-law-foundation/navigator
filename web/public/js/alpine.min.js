/*!
 * Alpine.js v3.14.3 — https://alpinejs.dev/
 * Copyright (c) 2019-2024 Caleb Porzio and contributors, MIT.
 *
 * Vendored into this repo on 2026-05-26 from:
 *   https://unpkg.com/alpinejs@3.14.3/dist/cdn.min.js
 *
 * Loaded with `defer` from PageLayout. Used sparingly — only in the
 * admin sub-tree — for small in-page reactivity (confirm modals,
 * inline edit toggles). Marketing pages stay JS-free.
 *
 * Bump procedure: re-download to this path, keep the banner, run
 * the admin browser_e2e tests. Note: if a future strict CSP is
 * added, Alpine's x-on:* handlers will need `script-src 'unsafe-eval'`
 * or a nonce — scope Alpine usage so that's tractable.
 */
