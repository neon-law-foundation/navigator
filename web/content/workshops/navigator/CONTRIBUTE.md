...
Neon Law Navigator is open source under the Apache-2.0 and MIT licenses, built and run by the Neon Law Foundation, a
501(c)(3). The mission — putting the rights already written into law within reach of the people they belong to — only
moves if the corpus keeps getting better, and that improvement comes from a community, not a vendor. This workshop is
the map of how to join it. There are five ways to contribute, and they range from a single GitHub issue to simply using
the platform; pick the one that fits the time you have.
...
A show-and-tell is the live version of the [Using Neon Law Navigator](/foundation/nebula/workshops/use-the-navigator)
workshop: an hour where we build a notation in front of you and answer whatever you bring. They are free, and you
register from the event page. Showing up — asking a hard question, telling us what your practice needs — is a
contribution, because it points the next release at the work that matters. Find the city and date nearest you on the
[show-and-tell schedule](/foundation/nebula/show-and-tell).
...
[Deploying](/foundation/nebula/workshops/deploy-the-navigator).

---

Using the platform is not a lesser contribution — it is the one that generates all the others. A lawyer who runs a real
matter in [Using Neon Law Navigator](/foundation/nebula/workshops/use-the-navigator) finds the missing checklist item;
an operator who stands up an instance in [Deploying Neon Law
