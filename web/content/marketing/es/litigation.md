...
<div class="litigation-phases" aria-label="Secuencia de fases de litigio">
  <section class="litigation-phase litigation-phase-0"><p class="phase-num">Fase 0</p><h3>Evaluación del caso</h3>
    <p>Intake, conflicto, evaluación del caso y cotización por fase. Suele acreditarse a Fase 1.</p></section>
  ...
  <section class="litigation-phase litigation-phase-4"><p class="phase-num">Fase 4</p><h3>Juicio</h3>
    <p>Preparación para juicio y el juicio en sí. Cotizado antes de que empiece la fase.</p></section>
  <section class="litigation-phase litigation-phase-5"><p class="phase-num">Fase 5</p><h3>Post-juicio / apelación</h3>
