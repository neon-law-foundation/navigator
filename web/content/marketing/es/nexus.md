...
pricing:
  - title: "Neon Law Nexus"
    price: "$2,222"
    cadence: "/mes"
    blurb: "Todo su equipo legal y de operaciones — todo salvo el litigio, una tarifa mensual fija."
    features:
      - "Contratos, entidad, privacidad y cumplimiento — sin facturación por asunto"
      - "Gestión de la tabla de capitalización incluida para su sociedad C de Nevada — constituya con nosotros"
...
# Un asesor jurídico general por iguala, por $2,222 al mes

Usted construyó la empresa; el contrato que nadie entendió, la factura de la nube que nadie pudo explicar y el
cuestionario de seguridad para el que nadie tuvo tiempo aterrizaron todos en un solo escritorio —el suyo. Neon Law Nexus
le quita ese escritorio de encima: un abogado con licencia, en el proceso de cada asunto, por una sola tarifa mensual
fija.
