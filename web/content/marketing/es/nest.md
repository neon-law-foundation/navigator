...
pricing:
  - title: "Neon Law Nest"
    price: "$1,111"
    cadence: "/año"
    blurb: "Una entidad simple para resguardar lo que posee — constituida, acordada y con abogado por una tarifa anual."
    features:
      - "Constitución de una entidad de Nevada — una LLC, una sin fines de lucro u otra forma simple"
      - "Un acuerdo operativo (o estatutos) redactado para lo que la entidad resguarda"
...
# Una entidad de Nevada para resguardar lo que posee, por $1,111 al año

Neon Law Nest es una entidad tenedora —para poseer un inmueble en alquiler, una inversión o un solo activo, o para
levantar una pequeña organización sin fines de lucro. Una tarifa anual la constituye ante el estado, redacta su acuerdo
operativo, le da un agente registrado de Nevada, presenta su licencia del condado de Washoe y pone un abogado a su
trabajo legal de rutina.
