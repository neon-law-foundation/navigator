...
slug: node
description: >
  Neon Law Node is an attorney attestation, recorded on-chain. A licensed attorney confirms a fact — like your
  accredited-investor status — from the information you provide, and writes it to Solana: our wallet, your wallet, and a
  hash of the signed document.
pricing:
  - title: "Neon Law Node"
    price: "$44"
    cadence: " each"
    blurb: "An attorney attestation, recorded on-chain."
    features:
      - "A licensed attorney confirms the fact from the information and documents you provide"
...
# An attorney attestation, recorded on-chain

Some facts need a lawyer to vouch for them — that you qualify as an accredited investor, that a record says what a
