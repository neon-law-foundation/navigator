...
Neon Law Foundation Nimbus puts Neon Law Navigator — the open-source legal-operations platform — onto your own
infrastructure, under your own name. The Foundation does the installation, copies your data across, trains your people,
and then hands you the keys. Because Neon Law Navigator is open source and your operators learn to run it, there is
nothing to renew: you own your instance, your data, and your upgrade path when we leave.
...
**Week one is the install.** We stand Neon Law Navigator up on your own Google Cloud project and copy your existing data
