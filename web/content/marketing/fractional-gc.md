...
pricing:
  - title: "Neon Law Nexus"
    price: "$2,222"
    cadence: "/month"
    blurb: "Your whole legal and operations bench — everything but litigation, one fixed monthly fee."
    features:
      - "Contracts, entity, privacy, and compliance work — no per-matter billing"
      - "Cap-table management included for your Nevada C corp — incorporate with us, Nevada over Delaware"
...
# A general counsel on retainer, for $2,222 a month

You built the company; the contract nobody understood, the cloud bill nobody could explain, and the security
questionnaire nobody had time for all landed on one desk — yours. Neon Law Nexus takes that desk off your hands: one
licensed attorney, in the loop on every matter, for one flat monthly fee.
