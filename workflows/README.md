...
Workflow specs live in the YAML frontmatter of notation templates under `notation_templates/` — see
`notation_templates/engagements/retainer.md`. The crate extracts the `workflow:` block, typechecks the transitions, and
