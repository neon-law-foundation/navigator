...
pub fn navigator_default_rules() -> Vec<Box<dyn Rule>> {
    use crate::{
        ...
        F108TemplateCodeRequired, F109OutputFormat, M001HeadingIncrement, M003HeadingStyle,
...
mod tests {
    ...
    const EXPECTED_DEFAULT_RULE_CODES: &[&str] = &[
        "S101", "N101", "N102", "N103", "N104", "N105", "N106", "N107", "N108", "N109", "M001",
        "M003", "M004", "M005", "M007", "M009", "M010", "M011", "M012", "M018", "M019", "M020",
        "M021", "M022", "M023", "M024", "M026", "M027", "M028", "M029", "M030", "M031", "M032",
        "M034", "M035", "M037", "M038", "M039", "M040", "M042", "M045", "M046", "M047", "M048",
        "M049", "M050", "M051", "M052", "M053", "M054", "M055", "M056", "M058", "M059", "M060",
    ];
