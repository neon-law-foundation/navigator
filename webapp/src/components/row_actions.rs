...
mod tests {
    ...
    fn renders_all_three_verbs_packed_in_one_group() {
        fn app() -> Element {
            rsx! {
                RowActions {
                    ...
                    edit_href: "/lawyer/people/42/edit".to_string(),
                    delete_action: "/lawyer/people/42/delete".to_string(),
        ...
        assert!(
            html.contains(r#"href="/lawyer/people/42/edit""#),
            "edit link: {html}"
        );
    ...
    fn delete_is_a_native_post_form_with_csrf_and_no_htmx() {
        ...
        assert!(html.contains(r#"action="/lawyer/people/42/delete""#));
        assert!(
    ...
    fn delete_method_defaults_to_post_and_is_overridable_for_a_preview() {
        fn production() -> Element {
            rsx! { RowActions { delete_action: "/lawyer/people/42/delete".to_string() } }
        }
