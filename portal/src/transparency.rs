//! `/transparency` — the Foundation's public-disclosure page.
//!
...
//!
//! The determination-letter PDF is served straight from `server/public/`; this
//! module loads the *narrative* documents from `server/content/foundation/`:
//!
...
//!   (`2026-q2.md`) or `YYQN_minutes.md` (`26Q2_minutes.md`) →
...
mod tests {
    ...
    fn bundled_foundation_directory_loads_cleanly() {
        // Guards the real `server/content/foundation/` tree and documents the
        ...
        let q2_2026 = ix
            .get("26q2")
            .expect("the Q2 2026 quarter of minutes loads at 26q2");
        assert_eq!(q2_2026.category, DocCategory::Minutes);

        // One quarter, Q2 2026 — the only recorded board meeting.
        ...
        assert_eq!(minutes.last().unwrap().slug, "26q2");
