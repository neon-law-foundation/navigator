...
"Client"), reachable at `{{client_email}}`, for **Neon Law Nexus** — fractional general-counsel services — on the matter
referred to as `{{project_name}}`.

**The work and the fee.** The Firm acts as your company's fractional general counsel: `{{product_description}}`. This is
an ongoing engagement billed as a flat monthly subscription. The subscription renews each month until either party ends
