...
"Client"), reachable at `{{client_email}}`, for **Neon Law Nucleus** — the formation of an investment fund — on the
matter referred to as `{{project_name}}`.

**The work and the fee.** The Firm will form the Nevada fund and the general-partner and management entities that go
with it, and prepare the formation and governance documents: `{{product_description}}`. This is a flat fee for the
formation, billed once when the matter closes; the Nevada filing fees and any registered-agent charges are passed
through at cost.
