...
- **Keys are dotted namespaces** so they document themselves: `nav.home`, `nav.services`, `auth.sign_in`,
  `banner.not_accepting`, `cta.email`, `switcher.label`, `error.not_found`.
...
web/content/marketing/            # English (source)
  home.md  corporate.md  estate.md  fractional-gc.md  litigation.md  nautilus.md  services.md
